...
def main(argv):
	...
	jList = [0.1,0.3,0.5,0.7,0.9]
	#jList = [0.7,0.8,0.9]
	#jList = [0.9]
	#nList = [0.01,0.03,0.1]
	nList = [0.01,0.02,0.03,0.05,0.08,0.1,0.12]
	#nList = [0.08,0.1,0.12]
	#nList = [0.1]
	...
	sDict = {'tetra': [0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6,0.65,0.7],
			'raiphy': [-19.0,-18.5,-18.0,-17.5,-17.0,-16.5,-16.0,-15.5,-15.0],
